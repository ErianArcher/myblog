...
def create_args_string(length):
    """
    To create an argument string
    :param length:
    :return: an argument string with length-1 quotes
    """
    args_list = []
...
class Model(dict, metaclass=ModelMetaclass):
    ...
    def find(cls, pk):
        ...
        :return: the specific object of the class with pk as its primary key
        """
